...
@interface HXView () <UITableViewDataSource,UITableViewDelegate>
...
@interface HXView (FullPickerViewDelegate)<FullScreenPickerViewDelegation>
...
-(void) openPikerView{
    ...
    [pickerView showWith:self.dataMutArray index:0];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        // titleLable.textColor = UIColorFromRGB(0x7f7f7f);
...
@implementation HXView(FullPickerViewDelegate)
